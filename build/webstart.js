...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.compile = exports.nestedRets = exports.run = exports.runPython = void 0;
...
function run(watSource) {
    return __awaiter(this, void 0, void 0, function () {
        var wabtApi, importObject, parsed, binary, wasmModule;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
var watBuilder = /** @class */ (function () {
    ...
    watBuilder.prototype.toCode = function () {
...
function compile(source) {
    ...
    // number of define statements
    var n = ast_1.countDefDeclStmts(ast);
    var defStmts = ast.slice(0, n);
    var rest = ast.slice(n);
    var iout = defStmts
        .filter(function (s) { return s.tag == "assign"; })
        .reduce(function (acc, s) {
        if (s.tag != "assign") {
    ...
    var out = (iout.printLast) ? "(result i32)" : "";
    var code = ["(module"].concat(["(func $print (import \"imports\" \"print\") (param i32) (result i32))"], ["(func $pow (import \"imports\" \"pow\") (param i32) (param i32) (result i32))"], iout.defs, ["(func (export \"_start\") " + out], ["(local $___IMPL_RET i32)"], progBody, (iout.printLast) ? ["(local.get $___IMPL_RET)))"] : [""]);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.inferExprType = exports.checkReturnType = exports.typeCheck = exports.typeCheckProgram = void 0;
var ast_1 = __webpack_require__(/*! ./ast */ "./ast.ts");
var errors_1 = __webpack_require__(/*! ./errors */ "./errors.ts");
